...
$APPLICATION->SetPageProperty("description", "Устройства грозозащиты CMD");
$APPLICATION->SetPageProperty("keywords", "грозозащита, молниезащита, CMD");
$APPLICATION->SetPageProperty("title", "Устройства грозозащиты CMD");
$APPLICATION->SetTitle("Устройства грозозащиты CMD");
?>
 ...
 <?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SEF_URL_TEMPLATES" => array(
			...
			"compare" => "/action/lightningprotection/compare.php?action=#ACTION_CODE#",
		),
