...
$APPLICATION->SetPageProperty("description", "Системы оповещения от ТЕКО - Казань, Чебоксары, Альметьевск, Набережные Челны");
$APPLICATION->SetPageProperty("keywords", "Микрофоны, усилители, микшеры, динамики, интеллектуальные системы, громкоговорители");
$APPLICATION->SetPageProperty("title", "Системы оповещения от ТЕКО: ТЕхника Которая Охраняет");
