...
$APPLICATION->SetPageProperty("description", "СКУД от ТЕКО - Казань, Чебоксары, Альметьевск, Набережные Челны");
$APPLICATION->SetPageProperty("keywords", "Оборудование GATE, PERCo, CAME, Доводчики, замки, металлоискатели, считыватели, шлагбаумы, калитки");
$APPLICATION->SetPageProperty("title", "СКУД от ТЕКО: ТЕхника Которая Охраняет");
...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			10 => "POTREBLYAEMAYA_MOSHCHNOST_VT",
			11 => "VSTROENNYY_RIP",
			12 => "NALICHIE_INTERFEYSA_RS_485",
			13 => "NALICHIE_SETEVOGO_PORTA",
			14 => "KOLICHESTVO_SOBYTIY_V_PAMYATI",
			15 => "KOLICHESTVO_KART_KLYUCHEY",
			16 => "VES_STVORKI_DO_KG",
			17 => "SHIRINA_STVORKI_DO_KG",
			18 => "VREMYA_OTKRYVANIYA_SEK",
			19 => "VES_DVERI_DO_KG",
			20 => "PROPUSKNAYA_SPOSOBNOST_CHEL_SEK",
			21 => "SHIRINA_PROKHODA_MM",
			22 => "USILIE_UDERZHANIYA_KG",
			23 => "",
		),
