...
$APPLICATION->SetPageProperty("description", "Распродажа товаров от ТЕКО - Казань, Чебоксары, Альметьевск, Набережные Челны");
$APPLICATION->SetPageProperty("keywords", "Микрофоны, усилители, микшеры, динамики, интеллектуальные системы, громкоговорители");
$APPLICATION->SetPageProperty("title", "Распродажа товаров от ТЕКО: ТЕхника Которая Охраняет");
  ...
  <?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			5 => "PROIZVODITEL",
			6 => "PROCHEE",
			7 => "NOMINALNAYA_NAGRUZKA_VYKHODA_A",
			8 => "VSTROENNYY_MIKROFON",
			9 => "POTREBLYAEMYY_TOK_MA",
			10 => "TEMPERATURA_EKSPLUATATSII_S",
			11 => "VYKHODNAYA_MOSHCHNOST_VT",
			12 => "UROVEN_ZVUKOVOGO_DAVLENIYA_DB",
			13 => "POTREBLYAEMAYA_MOSHCHNOST_VT",
			14 => "SOPROTIVLENIE_OM",
			15 => "VSTROENNYY_RIP",
			16 => "NALICHIE_RAZEMA_USB",
			17 => "MASSA_KG",
			18 => "KOLICHESTVO_USTANOVOCHNYKH_MEST_U",
			19 => "",
		),
