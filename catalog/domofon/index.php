 ...
 <?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FILTER_PROPERTY_CODE" => array(
			0 => "PROIZVODITEL",
			1 => "RAZMER_EKRANA_DYUYM",
			2 => "KOLICHESTVO_VIDEOVKHODOV",
			3 => "PODKLYUCHENIE_DOPOLNITELNOY_AUDIOTRUBKI",
			4 => "SOVMESTIMOST_S_PODEZDNYM_DOMOFONOM",
			5 => "RAZRESHENIE_VIDEOKAMERY_TVL",
			6 => "VSTROENNAYA_PAMYAT",
			7 => "RAZEM_KARTY_PAMYATI",
			8 => "",
		),
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			4 => "CML2_ARTICLE",
			5 => "PROIZVODITEL",
			6 => "RAZMER_EKRANA_DYUYM",
			7 => "KOLICHESTVO_VIDEOVKHODOV",
			8 => "PODKLYUCHENIE_DOPOLNITELNOY_AUDIOTRUBKI",
			9 => "SOVMESTIMOST_S_PODEZDNYM_DOMOFONOM",
			10 => "RAZRESHENIE_VIDEOKAMERY_TVL",
			11 => "VSTROENNAYA_PAMYAT",
			12 => "RAZEM_KARTY_PAMYATI",
			13 => "PROCHEE",
			14 => "NOMINALNAYA_NAGRUZKA_VYKHODA_A",
			15 => "VYSOTA_USTANOVKI_M",
			16 => "NALICHIE_IK_PODSVETKI",
			17 => "DALNOST_IK_PODSVETKI",
			18 => "TEMPERATURA_EKSPLUATATSII_S",
			19 => "KOLICHESTVO_ABONENTOV",
			20 => "KOLICHESTVO_VYKHODOV",
			21 => "CHUVSTVITELNOST_LK",
			22 => "NAPRYAZHENIE_PITANIYA_V",
			23 => "TIP",
			24 => "UGOL_OBZORA_VIDEOKAMERY_",
			25 => "",
		),
