...
$APPLICATION->SetPageProperty("description", "ИБП, Аккумуляторы от ТЕКО - Казань, Чебоксары, Альметьевск, Набережные Челны");
$APPLICATION->SetPageProperty("keywords", "Аккумуляторы, батареи, Источники бесперебойного питания, ИБП Бастион, Сетевые источники питания");
$APPLICATION->SetPageProperty("title", "ИБП, Аккумуляторы от ТЕКО: ТЕхника Которая Охраняет");
...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FILTER_PROPERTY_CODE" => array(
			...
			1 => "KOLICHESTVO_AKB",
			2 => "EMKOST_AKB_A_CH",
			3 => "VYKHODNOE_NAPRYAZHENIE_V",
			4 => "NOMINALNAYA_NAGRUZKA_VYKHODA_A",
			5 => "",
		),
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			1 => "CML2_ARTICLE",
			2 => "VES_S_UPAKOVKOY_KG",
			3 => "PROIZVODITEL",
			4 => "KOLICHESTVO_AKB",
			5 => "EMKOST_AKB_A_CH",
			6 => "VYKHODNOE_NAPRYAZHENIE_V",
			7 => "PROCHEE",
			8 => "KOLICHESTVO_VYKHODOV",
			9 => "NOMINALNAYA_NAGRUZKA_VYKHODA_A",
			10 => "VYSOTA_USTANOVKI_M",
			11 => "NAPRYAZHENIE_PITANIYA_V",
			12 => "STEPEN_ZASHCHITY",
			13 => "TEMPERATURA_EKSPLUATATSII_S",
		...
		"DETAIL_PROPERTY_CODE" => array(
			...
			1 => "KOMPLEKTATSIYA",
			2 => "CML2_ARTICLE",
			3 => "VES_S_UPAKOVKOY_KG",
			4 => "PROIZVODITEL",
			5 => "KOLICHESTVO_AKB",
			6 => "EMKOST_AKB_A_CH",
			7 => "VYKHODNOE_NAPRYAZHENIE_V",
			8 => "PROCHEE",
			9 => "KOLICHESTVO_VYKHODOV",
			10 => "NOMINALNAYA_NAGRUZKA_VYKHODA_A",
			11 => "VYSOTA_USTANOVKI_M",
			12 => "NAPRYAZHENIE_PITANIYA_V",
			13 => "STEPEN_ZASHCHITY",
			14 => "TEMPERATURA_EKSPLUATATSII_S",
			15 => "POTREBLYAEMAYA_MOSHCHNOST_VT",
			16 => "MASSA_KG",
			17 => "",
		),
