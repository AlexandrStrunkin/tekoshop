...
$APPLICATION->SetPageProperty("description", "Ищете надежную GSM систему охраны и безопасности для дачи по доступной цене – заходите на Teko-Shop и заказывайте лучшие и надежные решения!");
$APPLICATION->SetPageProperty("title", "GSM система охраны и безопасности дачи, готовый комплект системы безопасности по доступной цене");
$APPLICATION->SetPageProperty("keywords", "система охраны, сигнализация");
$APPLICATION->SetTitle("Охрана и безопасность дачи");
