...
$APPLICATION->SetPageProperty("title", "Беспроводная система безопасности для дачи, готовый комплект системы безопасности по доступной цене");
$APPLICATION->SetPageProperty("description", "Ищете надежную беспроводную систему безопасности для дачи по доступной цене – заходите на Teko-Shop и заказывайте лучшие и надежные решения!");
$APPLICATION->SetPageProperty("keywords", "система охраны, сигнализация");
$APPLICATION->SetTitle("Охрана дачи (беспроводная)");
