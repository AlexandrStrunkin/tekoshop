...
$APPLICATION->SetPageProperty("title", "Беспроводная охранно-пожарная сигнализация для квартиры, готовый комплект системы безопасности по доступной цене");
$APPLICATION->SetPageProperty("keywords", "система охраны, сигнализация");
$APPLICATION->SetPageProperty("description", "Ищете надежную беспроводную охранно-пожарную сигнализацию для квартиры по доступной цене – заходите на Teko-Shop и заказывайте лучшие и надежные решения!");
$APPLICATION->SetTitle("Беспроводная охранная пожарная сигнализация для квартиры");
