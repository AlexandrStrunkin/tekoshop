...
$APPLICATION->SetPageProperty("title", "GSM система охраны и безопасности гаража, готовый комплект системы безопасности по доступной цене");
$APPLICATION->SetPageProperty("description", "Ищете надежную GSM систему охраны и безопасности для гаража по доступной цене – заходите на Teko-Shop и заказывайте лучшие и надежные решения!");
$APPLICATION->SetPageProperty("keywords", "система охраны, сигнализация");
$APPLICATION->SetTitle("GSM охрана гаража");
