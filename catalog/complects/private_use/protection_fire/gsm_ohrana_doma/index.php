...
$APPLICATION->SetPageProperty("description", "Ищете надежную систему безопасности для дома и коттеджа с GSM по доступной цене – заходите на Teko-Shop и заказывайте лучшие и надежные решения!");
$APPLICATION->SetPageProperty("title", "GSM охрана дома и коттеджа, готовый комплект системы безопасности по доступной цене");
$APPLICATION->SetTitle("GSM охрана дома, коттеджа");
