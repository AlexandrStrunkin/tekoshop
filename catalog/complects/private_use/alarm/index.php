...
$APPLICATION->SetPageProperty("title", "Готовые решения аварийных систем безопасности по доступным ценам");
$APPLICATION->SetPageProperty("description", "В интернет-магазине Teko-Shop вы можете купить готовые решения аварийных систем безопасности по доступным ценам.");
