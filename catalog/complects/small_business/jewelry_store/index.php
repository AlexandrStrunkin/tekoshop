...
$APPLICATION->SetPageProperty("title", "Готовое решение автономной системы безопасности ювелирного магазина по доступной цене");
$APPLICATION->SetPageProperty("description", "Типовое решение качественной системы безопасности для охраны ювелирного магазина по доступной цене в интернет-магазине Teko-Shop.");
$APPLICATION->SetPageProperty("keywords", "система охраны, сигнализация");
$APPLICATION->SetTitle("Охрана ювелирного магазина");
