...
$APPLICATION->SetPageProperty("title", "Готовое решение автономной охраны небольшого помещения по доступной цене");
$APPLICATION->SetPageProperty("description", "Ищете качественное и недорогое готовое решение системы охраны коммерческих объектов, закажите решение с использованием радиоканальной системы охранно-пожарной сигнализации Астра-РИ-М.");
$APPLICATION->SetPageProperty("keywords", "система охраны, сигнализация");
$APPLICATION->SetTitle("Для офисного центра");
