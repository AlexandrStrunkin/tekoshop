...
$APPLICATION->SetPageProperty("title", "Готовое решение автономной охраны банкомата по доступной цене");
$APPLICATION->SetPageProperty("description", "Типовое решение для охраны банкомата или терминала оплаты от взлома или кражи по доступной цене в интернет-магазине Teko-Shop.");
$APPLICATION->SetPageProperty("keywords", "система охраны, сигнализация");
$APPLICATION->SetTitle("Охрана банкомата");
