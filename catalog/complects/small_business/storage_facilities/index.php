...
$APPLICATION->SetPageProperty("title", "Готовое решение автономной охраны складов и складских помещений по доступной цене");
$APPLICATION->SetPageProperty("description", "Типовое предложение для охраны склада или аналогичного объекта, размещенного в металлическом боксе по доступной цене в интернет-магазине Teko-shop.");
$APPLICATION->SetPageProperty("keywords", "система охраны, сигнализация");
$APPLICATION->SetTitle("Оснащение складских помещений");
