...
$APPLICATION->SetPageProperty("title", "Готовые решения для удаленного контроля температуры по доступной цене");
$APPLICATION->SetPageProperty("description", "В интернет-магазине Teko-Shop вы можете купить готовые комплекты систем для удаленного контроля температуры в доме, даче и коттедже по доступным ценам.");
$APPLICATION->SetPageProperty("keywords", "система охраны, сигнализация");
$APPLICATION->SetTitle("Удаленный контроль температуры с помощью SMS");
