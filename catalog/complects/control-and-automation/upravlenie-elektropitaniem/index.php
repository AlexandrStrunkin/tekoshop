...
$APPLICATION->SetPageProperty("title", "Готовые решения для удаленного контроля сетевого напряжения 220В по доступной цене");
$APPLICATION->SetPageProperty("description", "В интернет-магазине Teko-Shop вы можете купить готовые комплекты систем для удаленного контроля сетевого напряжения в доме, даче и коттедже по доступным ценам.");
$APPLICATION->SetPageProperty("keywords", "система охраны, сигнализация");
$APPLICATION->SetTitle("Контроль сетевого напряжения 220В");
