...
$APPLICATION->SetPageProperty("description", "Взрывозащищенное оборудование от ТЕКО - Казань, Чебоксары, Альметьевск, Набережные Челны");
...
$APPLICATION->SetPageProperty("title", "Взрывозащищенное оборудование от ТЕКО: ТЕхника Которая Охраняет");
...
?> <?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SEF_MODE" => "Y",
		"SEF_FOLDER" => "/catalog/vzryvozashhishhennoe-oborudovanie/",
		"AJAX_MODE" => "N",
		"AJAX_OPTION_JUMP" => "N",
		"AJAX_OPTION_STYLE" => "Y",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			10 => "STEPEN_ZASHCHITY",
			11 => "TEMPERATURA_EKSPLUATATSII_S",
			12 => "VARIANT_USTANOVKI",
			13 => "UROVEN_ZVUKOVOGO_DAVLENIYA_DB",
			14 => "VSTROENNYY_RIP",
			15 => "TIP",
			16 => "NALICHIE_INTERFEYSA_RS_485",
			17 => "ZASHCHISHCHAEMAYA_PLOSHCHAD_DO_KV_M",
			18 => "UGOL_ZONY_OBNARUZHENIYA_",
			19 => "DALNOST_DEYSTVIYA_DO_M",
			20 => "MARKIROVKA_VZRYVOZASHCHITY",
			21 => "PODKLYUCHENIE",
			22 => "TOK_KOMMUTATSII_A",
			23 => "NAPRYAZHENIE_KOMMUTATSII_V",
			24 => "TEMPERATURA_SRABATYVANIYA_S",
			25 => "CHASTOTA_MGTS",
			26 => "ZASHCHITA_OT_ZHIVOTNYKH",
			27 => "",
		),
