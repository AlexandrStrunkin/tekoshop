...
$APPLICATION->SetPageProperty("description", "Вакансии ТЕКО");
$APPLICATION->SetPageProperty("keywords", "Вакансии ТЕКО, требуется в ТЕКО");
$APPLICATION->SetPageProperty("title", "Вакансии ТЕКО");
$APPLICATION->SetTitle("Вакансии ТЕКО");
?> 
<div class="row">
<div class="col-main col-xs-12 col-sm-9">
<div class="padding-s">
<div class="std" style="font: 14px/1.4 Arial, Helvetica, sans-serif;"><div class="clear"></div>
<div id="imcontent" dir="ltr"> <?$APPLICATION->IncludeComponent(
...
);?><span dir="ltr" style="font-family: 'Segoe UI'; word-wrap: break-word; color: rgb(0, 0, 0); font-size: 12pt; direction: ltr;">
    <br />
