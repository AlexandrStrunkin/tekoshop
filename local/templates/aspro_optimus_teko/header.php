	...
	<body id="main">
        ...
        if ($arBackgroundImage) {
            if ($arBackgroundImage['PROPERTY_LEFT_BACKGROUND_BUTTON_VALUE']) {?>        
                <a class="left_background_button" href="<?=$arBackgroundImage['PROPERTY_LEFT_BACKGROUND_BUTTON_VALUE']?>"></a>
            <?}
            if ($arBackgroundImage['PROPERTY_RIGHT_BACKGROUND_BUTTON_VALUE']) {?>        
                <a class="right_background_button" href="<?=$arBackgroundImage['PROPERTY_RIGHT_BACKGROUND_BUTTON_VALUE']?>"></a>
            <?}
        }?>        
						...
						<div class="wrapper_inner">
							<div class="top_inner">
								...
								<div class="city-select">
									<?Bitrix\Main\Page\Frame::getInstance()->startDynamicWithID('city-select-block');?>
										<a href="#" class="js_city_title" data-cityname="<?=$currentLocation["CITY_NAME"]?>"><?=$currentLocation["CITY_NAME"]?></a>
										<?/*if(!$_COOKIE['city_verified']):?>
											<div class="city-verifier">
												<div class="cv-container">
													<div class="cv-title" data-cityname="<?=$currentLocation['CITY_NAME']?>">Ваш город - <b><?=$currentLocation['CITY_NAME']?></b>?</div>
													<div class="cv-buttons">
														<div class="cv-btn-yes">Да</div>
														<div class="cv-btn-change">Выбрать другой город</div>
													</div>
													<div class="cv-comment">От выбранного города зависят цены, наличие товара и способы доставки</div>
												</div>
											</div>
										<?endif;*/?>
										<div class="city-popup-list-wrapper">
											<div class="cpl-close"></div>
											<div class="city-popup-list-container">
											</div>
										</div>
									<?Bitrix\Main\Page\Frame::getInstance()->finishDynamicWithID('city-select-block', '');?>
								</div>
