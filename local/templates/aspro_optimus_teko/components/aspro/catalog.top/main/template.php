                    ...
                    <div class="item_info">
                        ...
                        <div class="cost prices clearfix">
                            ...
                            <?}
                                ...
                                //Ценовая политика, функция для работы с модулем формирования цен                                                                                                                                              
                                $min_price_id = 0;            
                                list($min_price, $old_price, $region_price, $bManufacturerPrice) = GetItemPrices($arResult["ELEMENTS"][$arItem["ID"]]["PRICES"], $arItem["IBLOCK_ID"], $arItem["PROPERTIES"]["PROIZVODITEL"]["VALUE_ENUM_ID"]);      
                                ?>
                                <?if($min_price):?>
