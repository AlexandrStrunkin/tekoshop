		...
		<div class="item_info">
			...
			<div class="cost prices clearfix">
				...
				<?}
					...
					// Ценовая политика
					$min_price_id = 0;
					list($min_price, $old_price, $region_price) = GetItemPrices(
						$arItem["PRICES"],
						array(
							"NOAUTH_USER_PRICES" => $arParams["NOAUTH_USER_PRICES"],
							"NOAUTH_MANUFACTURERS_PRICES" => $arParams["NOAUTH_MANUFACTURERS_PRICES"],
							"PROIZVODITEL_VALUE_ENUM_ID" => $arItem["PROPERTIES"]["PROIZVODITEL"]["VALUE_ENUM_ID"],
						)
					);
					?>
	                <?if($min_price):?>
