            ...
            <tr>
                ...
                ?>
                    ...
                    <td class="main">
                        ...
                        <?// Ценовая политика
                        $min_price_id = 0;
                        list($min_price, $old_price, $region_price, $bManufacturerPrice) = GetItemPrices($arElement["PRICES"], $arElement["IBLOCK_ID"], $arElement["PROPERTIES"]["PROIZVODITEL"]["VALUE_ENUM_ID"]);
                        ?>
