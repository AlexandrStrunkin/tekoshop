...
$MESS["SOA_TEMPL_ORDER_SUC"] = "Заказ <b>№#ORDER_ID#</b> от #ORDER_DATE#. Спасибо, Ваш заказ принят. Менеджер обязательно свяжется с Вами для уточнения деталей заказа.</br></br>";
...
$MESS["SOA_TEMPL_ORDER_SUC2"] = "Если Ваш заказ поступил в нерабочее время или выходной день, он будет обработан утром на следующий рабочий день.</br>";
$MESS["SOA_TEMPL_ORDER_SUC3"] = "Время обработки заказов с 8:00 до 19:00 в будние дни.</br>";
$MESS["SOA_TEMPL_ORDER_SUC4"] = "Тел менеджера: +7(843)212-22-55</br>";
$MESS["SOA_TEMPL_ORDER_SUC5"] = "При обращении к менеджеру обязательно называйте номер Вашего заказа.</br>";
$MESS["SOA_TEMPL_ORDER_SUC6"] = "Информация отправлена на Вашу электронную почту.</br></br>";