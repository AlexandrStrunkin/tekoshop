...
<? if (!empty($arResult["ORDER"])): ?>     
    <table class="sale_order_full_table confirm_page">
        <tr>
            <td>
    ...
    {?>
        ...
        <?= GetMessage("SOA_TEMPL_ORDER_SUC3")?>
        <?= GetMessage("SOA_TEMPL_ORDER_SUC4")?>
        <?= GetMessage("SOA_TEMPL_ORDER_SUC5")?>
        <?= GetMessage("SOA_TEMPL_ORDER_SUC6")?>
