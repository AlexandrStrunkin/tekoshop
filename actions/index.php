...
$APPLICATION->SetPageProperty("description", "ЗАО ТЕКО Контактная информация");
$APPLICATION->SetPageProperty("keywords", "ЗАО ТЕКО наши контакты, адреса магазинов, телефоны магазинов, номер ICQ, электронный ящик");
...
<!--<img id="bxid_925766" style="cursor: default;" src="/bitrix/components/bitrix/main.include/images/include.gif"  />-->
 <?$APPLICATION->IncludeComponent(
	"bitrix:voting.form",
	"mc_voting_form",
	Array(
